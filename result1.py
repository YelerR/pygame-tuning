...
def initGame():
    global gamePad, clock, background1, background2, fighter,rock, missile, explosion, missileSound,\
        gameOverSound, heart, item, valume, num, boss, boss_attack, explosion
    pygame.init()
...
def runGame():
    global gamePad, clock, background1, backgroud2, fighter,rock, missile, explosion, missileSound, heart, item, num, boss, boss_attack, explosion
